...
import com.mbds.hotelnfc.model.TagContent;
...
public class ReadNfcTagActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nfcReaderViewModel.getReadFailed().observe(this, readFailed -> {
            ...
            Intent i = new Intent(getApplicationContext(), WriteNfcTagActivity.class);
            startActivity(i);
        });
        ...
        nfcReaderViewModel.getTagRead().observe(this, readSuccess -> {
            for (TagContent s : readSuccess) {
                ...
                if (s.getType() == TagType.PHONE) {
                    ...
                    txtView2.setText("La cle est pour la " + s.getContent());
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action)
            ...
            if (!isNdef) {
                Intent writeTagIntent = new Intent(this, WriteNfcTagActivity.class);
